...
const Rooms = () => {
    ...
    <div id='/Rooms' className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 py-16 lg:mb-[20px] md:mb-[35px] px-4 grid lg:grid-cols-3 gap-4'>
    <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
    <h3 className='text-2x1 font-bold'>Fine Interior Rooms</h3>
    <p className='pt-4'>
    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error ipsam
              rerum iusto excepturi similique minus?
    </p>
    </div>
    <div className='grid grid-cols-2 col-span-2 gap2'>
    <img
